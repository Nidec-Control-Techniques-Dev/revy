      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Business Model: ${widget.businessModel?.join(', ') ?? 'N/A'}',
            ...
            Text('Fax No: ${widget.faxNo ?? 'N/A'}',
                style: GoogleFonts.robotoSlab(
                    ...
                    color: Colors.black)),
            const SizedBox(height: 8),
            Text('Category: ${widget.status ?? 'N/A'}',
                style: GoogleFonts.robotoSlab(
                    fontWeight: FontWeight.w500,
                    fontSize: 18,
                    color: Colors.black)),
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: Text('Status successfully changed from X to Y'),
                        actions: <Widget>[
                          TextButton(
                            child: Text('Cancel'),
                            onPressed: () {
