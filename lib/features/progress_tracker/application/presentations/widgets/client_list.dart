...
class ClientList extends StatelessWidget {
  ...
  List<Color> iconColor = [Colors.green[700]!,Colors.red[700]!,Colors.yellow[700]!];
        ...
        ...listItem.asMap().entries.map((entry) {
          ...
          return Column(children: [
            ...
            fontWeight: FontWeight.bold, // or FontWeight.w700 for a bolder appearance
                ...
                child: Text(valueItem,
            style: GoogleFonts.roboto(// or FontWeight.w700 for a bolder appearance
          ),),
              ),
                  trailing: Row(
                    ...
                    children: <Widget>[
                      Transform.scale(
                        scale: 0.5, // Scale down the icon to half its original size
                        child: Container(
                          decoration: BoxDecoration(
                            shape: BoxShape.circle, // Makes the container circular
                            border: Border.all(
                              color: iconBorderColor[idx], // Slightly darker shade of green
                              width: 2, // Border width
                            ),
                          ),
                          child: Icon(Icons.circle, color: iconColor[idx]), // Active status icon
                        ),
                      ),
                      Transform.scale(
                        scale: 0.5, // Scale down the icon to half its original size
                        child: const Icon(Icons.more_vert), // Another icon for example
                      ),
                    ],
                  ),
                  onTap: () {
